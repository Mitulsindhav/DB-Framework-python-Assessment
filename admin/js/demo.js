$().ready(function() {
    ...
    window_width = $(window).width();
        ...
        fixed_plugin_open = $('.side ar .sidebar-wrapper .nav li.active a p').html();
...
demo = {
    ...
    initDashboardPageCharts: function() {
        ...
        var chartActivity = Chartist.Bar('#client', data, options, responsiveOptions);
